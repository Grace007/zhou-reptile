package com.reptile.ly.model.scenery.job;
...
/**
 * 迪斯尼-同程景点产品Keyword的job类
 *
 */
@Table("t_ly_scenery_keyword_job")
public class LySceneryKeywordJob {
