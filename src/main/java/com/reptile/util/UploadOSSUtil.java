...
public class UploadOSSUtil {
	 ...
	 */ // oss-cn-beijing.aliyuncs.com
		// oss-cn-beijing.aliyuncs.com
	protected static String ossHttpDomain = "bds-dp-img-restaurant.oss-cn-hangzhou.aliyuncs.com";

	/**
	 * oss 上传下载接入点
	 */
	protected static String ossEndpoint = "oss-cn-hangzhou.aliyuncs.com";

	public static String bucketName = "bds-dp-img-restaurant";
