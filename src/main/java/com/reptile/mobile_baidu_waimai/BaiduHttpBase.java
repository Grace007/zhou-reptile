package com.reptile.mobile_baidu_waimai;
...
public class BaiduHttpBase {
    private static Logger logger = Logger.getLogger(HttpBase.class);
    private static final BaiduHttpBase instance = new BaiduHttpBase();
    ...
    private BaiduHttpBase() {
    }

    public static BaiduHttpBase getInstance() {
        return instance;
    }
