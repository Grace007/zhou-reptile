...
public class AmazonHttpBase {

    private static Logger logger = Logger.getLogger(AmazonHttpBase.class);
    private static final AmazonHttpBase instance = new AmazonHttpBase();
    ...
    private AmazonHttpBase() {
    }

    public static AmazonHttpBase getInstance() {
        return instance;
    }
    ...
    public synchronized static Response get(String url, String charset, Map<String, String> headers) throws Exception {
        ...
        String random_version = "54.0." + (2800 + (int) (Math.random() * 40)) + "."
                + (int) (Math.random() * 60);
