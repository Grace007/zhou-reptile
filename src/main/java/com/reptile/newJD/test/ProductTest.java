...
public class ProductTest {
	...
	public void test() throws Exception {
		...
		// String url =
		// "https://daojia.jd.com/client?functionId=productsearch%2Fsearch&body=%7B%22key%22%3A%22%22%2C%22catId%22%3A%22%22%2C%22storeId%22%3A%2211029652%22%2C%22sortType%22%3A1%2C%22page%22%3A1%2C%22pageSize%22%3A10%2C%22cartUuid%22%3A%22%22%2C%22promotLable%22%3A%221201:91864%22%2C%22timeTag%22%3A1500548030662555%7D&appVersion=4.3.0&appName=paidaojia&platCode=H5&lng=121.47865&lat=31.27078";
		...
		JSONArray productArray = new JSONObject(html).getJSONObject("result")
				.getJSONArray("searchResultVOList");
		for (int i = 0; i < productArray.length(); i++) {
			...
			for (int j = 0; j < tags.length(); j++) {
				product_promotions = product_promotions
						+ tags.getJSONObject(j).getString("iconText") + "	";
			}
